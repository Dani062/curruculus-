...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // =====================
    // Cargar archivos iniciales (perfil.jpeg y diploma.pdf)
    // =====================
    async function loadInitialFiles() {
        const profilePath = './perfil.jpeg';
        const diplomaPath = './diploma.pdf';
        
        // Función para cargar imagen de perfil directamente como URL
        async function loadProfilePhoto() {
            try {
                ...
                console.log('No se pudo cargar la foto de perfil automáticamente');
            }
        }
        
        // Función para cargar diploma PDF directamente como URL
        async function loadDiploma() {
            try {
                ...
                console.log('No se pudo cargar el diploma automáticamente');
            }
        }
        
        // Cargar archivos solo si no existen en localStorage
        if (!localStorage.getItem('cv_profile_photo')) {
            await loadProfilePhoto();
        }
        
        if (!localStorage.getItem('cv_diploma_pdf')) {
            await loadDiploma();
        }
    }
